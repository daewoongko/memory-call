...
export default function CareManagerScreen({ onDisplaySettings }) {
  ...
  if (!elders) return <main className="guardian care-manager-entry-loading"><div className="care-manager-loading"><p className={error ? "error" : "hint"}>{error || "어르신 정보를 불러오는 중…"}</p></div></main>;
